...
namespace Coursework
{
    class WorkWithDatabase //работа с БД
    {
        ...
        public void CreatingOrFindingTable()
        {
            ...
            if (MessageBox.Show("есть ли файл БД?", "Вопрос", MessageBoxButtons.YesNo) == DialogResult.No)
            {
                MessageBox.Show("Укажите папку, для создания БД");
                ...
                connect = new SQLiteConnection(@"Data Source = " + path+@"\DB.sqlite" + "; Version = 3");
